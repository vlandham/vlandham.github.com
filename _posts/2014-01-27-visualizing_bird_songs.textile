...
<script type="text/javascript" src="vis/js/d3.v3.min.js"></script>
...
<div id="bird_vis" class="spectrogram"></div>

<script>
      var sample = new Spectrogram('vis/data/bird_short.ogg', "#bird_vis", {width:600, height:200});
</script>
...
h2. HTML5 Web Audio API to the Rescue!
