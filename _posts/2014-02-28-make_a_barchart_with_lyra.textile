...
A sort of open source Adobe Illustrator geared toward data visualizations. Sounds pretty awesome, right? But does it work?!
...
I wanted to see what would be required in creating a really basic bar chart - as a way to start to learn more about this interesting tool. 
...
<div class="box">
*WARNING:* Lyra is labelled as _alpha_ and while already a great tool, its got some "issues":https://github.com/uwdata/lyra/issues . A few times I had to restart from scratch after getting the tool into an state I couldn't recover from. I expect these issues to go away over time, but buyer beware - you might feel some frustrations.
</div>
