...
<div class="box">
*WARNING:* Lyra is labelled as _alpha_ and while already a great tool, its got some "issues":https://github.com/uwdata/lyra/issues . A few times I had to restart from scratch after getting the tool into a state I couldn't recover from. I expect these issues to go away over time, but buyer beware - you might feel some frustrations.
</div>
...
Now we need to pull @Count@ down to the _Sort By_ field:
