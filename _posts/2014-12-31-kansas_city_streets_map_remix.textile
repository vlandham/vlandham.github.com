...
It took me a second to figure out that there were two types of projects - _style_ projects that deal with the look and feel of the map, and _source_ projects that are used to define data sources. Guess I should have read a "bit more of the documentation":https://www.mapbox.com/mapbox-studio/common-questions/#what-is-the-difference-between-style-and-source-projects !
...
<script src="https://gist.github.com/vlandham/35adbfc0ac5876544bcc.js?file=old_roads.css"></script>
...
<script src="https://gist.github.com/vlandham/35adbfc0ac5876544bcc.js?file=style.css"></script>
