...
And the "visualization code is on github"

*Warning Coffeescript*

The example is written in "CoffeeScript":http://coffeescript.org/ as I find it much easier to read and write than javascript. Hopefully this does not get in the way of you understanding what is going on. The original NYT visualization is in javascript. Let me know if something is confusing.
...
Hope this tutorial shows you some interesting ways to use D3's force layout. Its not just for force-directed graphs anymore!
